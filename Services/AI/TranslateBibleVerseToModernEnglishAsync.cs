...
{
  /// <summary>
  /// Returns either a url to where the new translation was stored or an empty string if none can be obtained or a string directive to be interpreted by the frontend.
  /// </summary>

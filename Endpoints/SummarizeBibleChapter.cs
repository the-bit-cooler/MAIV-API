...
public class SummarizeBibleChapter
{
    ...
    )
  {
    ...
    string userPrompt = $"Summarize {book} {chapter} from the {version} version of the Bible. Do not use a title with the chapter reference at the top of your GitHub markdown response. Just go right into your summary.";
